...
export const App = () => {
    ...
    const [storiesData,setStoriesData]=useState([{text: "",name: "",}]);

    useEffect(() => {
        fetch
        ('https://localhost:44303/api/story')
    ...
    // fetch('https://localhost:44303/api/story',{mode: 'no-cors'})
    //         .then(response => response.json())    
    //         .then(data => {
    //         console.log(data) 
    // })
